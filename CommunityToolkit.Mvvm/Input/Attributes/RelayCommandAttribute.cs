...
/// <summary>
///     An attribute that can be used to automatically generate <see cref="ICommand" /> properties from declared methods.
///     When this attribute
///     is used to decorate a method, a generator will create a command property with the corresponding
///     <see cref="IRelayCommand" /> interface
///     depending on the signature of the method. If an invalid method signature is used, the generator will report an
///     error.
///     <para>
///         In order to use this attribute, the containing type doesn't need to implement any interfaces. The generated
///         properties will be lazily
///         assigned but their value will never change, so there is no need to support property change notifications or
...
/// </code>
///         Will both generate an <see cref="IAsyncRelayCommand" /> property (using an <see cref="AsyncRelayCommand{T}" />
///         instance).
///         <code>
/// Task Method(T?);
...
/// </code>
///         Will both generate an <see cref="IAsyncRelayCommand{T}" /> property (using an
///         <see cref="AsyncRelayCommand{T}" /> instance).
///     </para>
/// </summary>
...
public sealed class RelayCommandAttribute : Attribute
{
    ...
    ///         <see cref="AsyncRelayCommand(Func{System.Threading.Tasks.Task}, AsyncRelayCommandOptions)" />
    ...
    /// }
    /// </code>
    ///         Where <c>LoginUserCommand</c> is an <see cref="IAsyncRelayCommand" /> defined in the class (or generated by
