...
public interface IAsyncRelayCommand : IRelayCommand, INotifyPropertyChanged
{
    ...
    ///     Thrown if <paramref name="parameter" /> is incompatible with the underlying
    ...
    /// </summary>
    /// <remarks>
    ///     If the underlying command is not running, or if it does not support cancelation, this method will perform no
    ///     action.
