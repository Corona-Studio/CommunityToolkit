...
/// </code>
///     The C# compiler will automatically convert that expression to a <see cref="MessageHandler{TRecipient,TMessage}" />
///     instance
///     compatible with
///     <see
...
///     It is also possible to register message handlers explicitly using the <see cref="IRecipient{TMessage}" />
///     interface.
...
///     all the handlers that are declared by the recipient type. Registration for individual handlers is supported as
///     well.
/// </summary>
public interface IMessenger
{
    ...
    ///     Thrown if <paramref name="recipient" /> or <paramref name="token" /> are
    ///     <see langword="null" />.
    /// </exception>
    ...
    /// <exception cref="System.ArgumentNullException">
    ///     Thrown if <paramref name="recipient" />, <paramref name="token" /> or
    ///     <paramref name="handler" /> are <see langword="null" />.
    /// </exception>
    ...
    /// <exception cref="System.ArgumentNullException">
    ///     Thrown if <paramref name="message" /> or <paramref name="token" /> are
    ///     <see langword="null" />.
    /// </exception>
