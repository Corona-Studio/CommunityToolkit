...
/// <summary>
///     An attribute that indicates that a given type should implement the <see cref="INotifyPropertyChanged" /> interface
///     and
///     have minimal built-in functionality to support it. This includes exposing the necessary event and having two
///     methods
///     to raise it that mirror <see cref="ObservableObject.OnPropertyChanged(PropertyChangedEventArgs)" /> and
///     <see cref="ObservableObject.OnPropertyChanged(string?)" />. For more extensive support, use
