...
public abstract class ObservableRecipient : ObservableObject
{
    ...
    /// </remarks>
    protected bool SetProperty<T>([NotNullIfNotNull("newValue")] ref T field, T newValue, bool broadcast,
    ...
    protected bool SetProperty<T>([NotNullIfNotNull("newValue")] ref T field, T newValue, IEqualityComparer<T> comparer,
        bool broadcast, [CallerMemberName] string? propertyName = null)
    {
    ...
    protected bool SetProperty<T>(T oldValue, T newValue, Action<T> callback, bool broadcast,
        [CallerMemberName] string? propertyName = null)
    {
    ...
    protected bool SetProperty<TModel, T>(T oldValue, T newValue, IEqualityComparer<T> comparer, TModel model,
        Action<TModel, T> callback, bool broadcast, [CallerMemberName] string? propertyName = null)
        where TModel : class
    {
        ArgumentNullException.ThrowIfNull(comparer);
        ArgumentNullException.ThrowIfNull(model);
